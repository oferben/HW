...
Ext.define('RetModel.controller.DevicesFormsUpdater', {
    ...
    updateGps: function(gpsRec) {
        console.log('DevicesFormsUpdater - updateGps was called!');
    ...
    updateCompass: function() {
        ...
        var compassData = Ext.ModelMgr.getModel('compassData');

        var compassStore = Ext.create('RetModel.store.CompassData');

        var compassForm = this.getCompassForm();

        var compassNumber = 700;

        setInterval(function() {
            compassStore.load();
            var compassRec = compassStore.first();
...
Ext.define('RetModel.controller.MapHandler', {
    ...
    updateCurrPosMarker: function(lat, long) {
        ...
        // To do - add to store and in init load it!
    ...
    drawLine: function(distance, bearing, title) {
        ...
        var image = new google.maps.MarkerImage('data/airplane.jpg',
        // This marker is 32 pixels wide by 32 pixels tall.
        new google.maps.Size(32, 32),
        // The origin for this image is 0,0.
        new google.maps.Point(0,0),
        ...
        // To do: save the points added to enable deletion and persistancy.
        /*
        console.info('MapHandler - drawLine - Marker is:');
        console.info(marker);
        var landingLineStore = Ext.getStore('LandingLineStore');
        landingLineStore.load();
        console.info('MapHandler - drawLine - store size is: ' + landingLineStore.getCount());
        newLine = Ext.create('RetModel.model.landingLine', {
        xStart: marker,
        xEnd: endPoint,
        date: new Date()
        }
    ...
    */
    ...
    initMap: function() {
        ...
        var mapOptions = {
            ...
            center: new google.maps.LatLng(39.958636,-75.20496),
            zoom: 14,
...
Ext.define('RetModel.controller.DevicesMonitor', {
    ...
    monitorCompass: function() {
        ...
        // To do - look at monitorGps
        var compassData = Ext.ModelMgr.getModel('compassData');
        var compassRec = Ext.create('RetModel.model.compassData', {
            x: 100,
            y: 200,
            z: 300,
            date: currDate
        ...
        console.log('compassStore size:' + compassStore.getCount());

        var compassRec3 = compassStore.first();

        var compassXVal = 0;
        var compassYVal = 0;
        var compassZVal = 0;
        var compassNumber = 400;
        ...
        compassYVal = e.beta;
        compassZVal = e.gamma;
        compassRec3.set('x',compassXVal);
        compassRec3.set('y',compassYVal);
        compassRec3.set('z',compassZVal);
        compassRec3.set('date',new Date());
        compassRec3.save();
        console.log('compassPosition (' + compassNumber + ') - compassRec3 was set. xVal:' + compassXVal + ', yVal:' + compassYVal + ', zVal:' + compassZVal + ', Date:' + new Date());
        compassNumber = compassNumber + 1;
        }
        });
        */
