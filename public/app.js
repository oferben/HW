...
Ext.define('RetModel.controller.MapHandler', {
    ...
    updateCurrPosMarker: function(lat, long) {
        ...
        marker.setIcon({
            path: google.maps.SymbolPath.FORWARD_CLOSED_ARROW,
            rotation: ((this.getCompassHeading() - this.getMapHeading() + 360) % 360),
            scale: 5,
            strokeColor: '#0101DF',
            strokeWeight: 2,
            anchor: new google.maps.Point(0,2)
    ...
    updateCurrPosHeading: function(bearing) {
        ...
        this.setCompassHeading(bearing);

        marker.setIcon({
            path: google.maps.SymbolPath.FORWARD_CLOSED_ARROW,
            rotation: ((bearing - this.getMapHeading() + 360) % 360),
            scale: 5,
            strokeColor: '#0101DF',
            strokeWeight: 2,
            anchor: new google.maps.Point(0,2)
